import { _ as _export_sfc, c as createElementBlock, ai as createStaticVNode, j as createBaseVNode, a as createTextVNode, t as toDisplayString, o as openBlock } from "./chunks/framework.CiOQmoww.js";
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    createBaseVNode("div", _hoisted_1, [
      ...
      createBaseVNode("p", null, [
        _cache[0] || (_cache[0] = createTextVNode("It's recommended to separate sections in your prompt with XML markup (e.g. ")),
        createBaseVNode("code", null, "<document> " + toDisplayString(_ctx.document) + " </document>", 1),
        _cache[1] || (_cache[1] = createTextVNode("). See ")),
      ...
      _cache[5] || (_cache[5] = createBaseVNode("p", null, [
        createBaseVNode("a", {
          href: "https://github.com/svilupp/PromptingTools.jl/blob/fd573d9f7018ee5660b27038d10a61a9c8a9a67b/src/llm_interface.jl#L392-L406",
          target: "_blank",
          rel: "noreferrer"
        }, "source")
      ], -1))
    ]),
    _cache[48] || (_cache[48] = createStaticVNode("", 113)),
    createBaseVNode("div", _hoisted_2, [
      _cache[10] || (_cache[10] = createStaticVNode("", 9)),
      createBaseVNode("p", null, [
        _cache[6] || (_cache[6] = createTextVNode("!!! Note: The prompt/AITemplate must have a placeholder ")),
        _cache[7] || (_cache[7] = createBaseVNode("code", null, "choices", -1)),
        _cache[8] || (_cache[8] = createTextVNode(" (ie, ")),
        createBaseVNode("code", null, toDisplayString(_ctx.choices), 1),
        _cache[9] || (_cache[9] = createTextVNode(") that will be replaced with the encoded choices"))
      ]),
      _cache[11] || (_cache[11] = createStaticVNode("", 21))
    ]),
    _cache[49] || (_cache[49] = createStaticVNode("", 73)),
    createBaseVNode("div", _hoisted_3, [
      _cache[16] || (_cache[16] = createStaticVNode("", 10)),
      createBaseVNode("p", null, [
        _cache[12] || (_cache[12] = createTextVNode("Use double handlebar placeholders (eg, ")),
        createBaseVNode("code", null, toDisplayString(_ctx.name), 1),
        _cache[13] || (_cache[13] = createTextVNode(") to define variables that can be replaced by the ")),
        _cache[14] || (_cache[14] = createBaseVNode("code", null, "kwargs", -1)),
        _cache[15] || (_cache[15] = createTextVNode(" during the AI call (see example)."))
      ]),
      _cache[17] || (_cache[17] = createStaticVNode("", 19))
    ]),
    _cache[50] || (_cache[50] = createStaticVNode("", 107)),
    createBaseVNode("div", _hoisted_4, [
      _cache[20] || (_cache[20] = createStaticVNode("", 7)),
      createBaseVNode("p", null, [
        _cache[18] || (_cache[18] = createTextVNode("Builds a history of the conversation to provide the prompt to the API. All unspecified kwargs are passed as replacements such that ")),
        createBaseVNode("code", null, toDisplayString(_ctx.key) + "=>value", 1),
        _cache[19] || (_cache[19] = createTextVNode(" in the template."))
      ]),
    ...
    createBaseVNode("div", _hoisted_5, [
      ...
      createBaseVNode("p", null, [
        _cache[22] || (_cache[22] = createTextVNode("Builds a history of the conversation to provide the prompt to the API. All unspecified kwargs are passed as replacements such that ")),
        createBaseVNode("code", null, toDisplayString(_ctx.key) + "=>value", 1),
        _cache[23] || (_cache[23] = createTextVNode(" in the template."))
      ]),
    ...
    createBaseVNode("div", _hoisted_6, [
      ...
      createBaseVNode("p", null, [
        _cache[26] || (_cache[26] = createTextVNode("Builds a history of the conversation to provide the prompt to the API. All unspecified kwargs are passed as replacements such that ")),
        createBaseVNode("code", null, toDisplayString(_ctx.key) + "=>value", 1),
        _cache[27] || (_cache[27] = createTextVNode(" in the template."))
      ]),
      ...
      _cache[32] || (_cache[32] = createBaseVNode("p", null, [
        createBaseVNode("a", {
          href: "https://github.com/svilupp/PromptingTools.jl/blob/fd573d9f7018ee5660b27038d10a61a9c8a9a67b/src/llm_ollama_managed.jl#L9-L21",
          target: "_blank",
          rel: "noreferrer"
        }, "source")
      ], -1))
    ...
    createBaseVNode("div", _hoisted_7, [
      ...
      createBaseVNode("p", null, [
        _cache[33] || (_cache[33] = createTextVNode("Builds a history of the conversation to provide the prompt to the API. All unspecified kwargs are passed as replacements such that ")),
        createBaseVNode("code", null, toDisplayString(_ctx.key) + "=>value", 1),
        _cache[34] || (_cache[34] = createTextVNode(" in the template."))
      ]),
    ...
    createBaseVNode("div", _hoisted_8, [
      ...
      createBaseVNode("p", null, [
        _cache[37] || (_cache[37] = createTextVNode("Builds a history of the conversation to provide the prompt to the API. All unspecified kwargs are passed as replacements such that ")),
        createBaseVNode("code", null, toDisplayString(_ctx.key) + "=>value", 1),
        _cache[38] || (_cache[38] = createTextVNode(" in the template."))
      ]),
    ...
    createBaseVNode("div", _hoisted_9, [
      ...
      createBaseVNode("ul", null, [
        createBaseVNode("li", null, [
          createBaseVNode("p", null, [
            _cache[41] || (_cache[41] = createTextVNode("All unspecified kwargs are passed as replacements such that ")),
            createBaseVNode("code", null, toDisplayString(_ctx.key) + "=>value", 1),
            _cache[42] || (_cache[42] = createTextVNode(" in the template."))
          ])
        ]),
      ...
      _cache[46] || (_cache[46] = createBaseVNode("p", null, [
        createBaseVNode("a", {
          href: "https://github.com/svilupp/PromptingTools.jl/blob/fd573d9f7018ee5660b27038d10a61a9c8a9a67b/src/llm_shared.jl#L12-L32",
          target: "_blank",
          rel: "noreferrer"
        }, "source")
      ], -1))
    ...
    _cache[57] || (_cache[57] = createBaseVNode("div", { style: { "border-width": "1px", "border-style": "solid", "border-color": "black", "padding": "1em", "border-radius": "25px" } }, [
      ...
      createBaseVNode("p", null, [
        createBaseVNode("a", {
          href: "https://github.com/svilupp/PromptingTools.jl/blob/fd573d9f7018ee5660b27038d10a61a9c8a9a67b/src/extraction.jl#L463-L555",
          target: "_blank",
          rel: "noreferrer"
        }, "source")
      ])
    ], -1)),
    _cache[58] || (_cache[58] = createStaticVNode("", 19))
  ]);
}
