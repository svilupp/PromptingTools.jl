...
#%%
cb = StreamCallback(out=stdout)
aigenerate("What is the 6th largest city in the Czech Republic? you can think, but in the answer I only want to see the city."; model="gpt-5.1-codex", streamcallback=cb)
#%%
# Ask normal question
