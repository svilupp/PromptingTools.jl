...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", null, [
    ...
    createBaseVNode("ul", null, [
      createBaseVNode("li", null, [
        createBaseVNode("p", null, [
          _cache[0] || (_cache[0] = createTextVNode("Description: Template for summarizing transcripts of videos and meetings into the decisions made and the agreed next steps. If you don't need the instructions, set ")),
    ...
    createBaseVNode("ul", null, [
      createBaseVNode("li", null, [
        createBaseVNode("p", null, [
          _cache[6] || (_cache[6] = createTextVNode("Description: Template for summarizing survey verbatim responses into 3-5 themes with an example for each theme. If you don't need the instructions, set ")),
    ...
    createBaseVNode("ul", null, [
      createBaseVNode("li", null, [
        createBaseVNode("p", null, [
          _cache[9] || (_cache[9] = createTextVNode("Description: Template for quick email drafts. Provide a brief in 5-7 words as headlines, eg, ")),
    ...
    createBaseVNode("ul", null, [
      createBaseVNode("li", null, [
        createBaseVNode("p", null, [
          _cache[15] || (_cache[15] = createTextVNode("Description: For writing Julia-style unit tests. It expects ")),
          _cache[16] || (_cache[16] = createBaseVNode("code", null, "code", -1)),
          _cache[17] || (_cache[17] = createTextVNode(" provided as a string (it can be the whole source code of your app). Instructions are a good way to guide the model which functions to test and how. If you don't need the instructions, set ")),
    ...
    createBaseVNode("ul", null, [
      createBaseVNode("li", null, [
        createBaseVNode("p", null, [
          _cache[23] || (_cache[23] = createTextVNode("Description: For writing Julia-style unit tests. The prompt is XML-formatted - useful for Anthropic models. It expects ")),
          _cache[24] || (_cache[24] = createBaseVNode("code", null, "code", -1)),
          _cache[25] || (_cache[25] = createTextVNode(" provided as a string (it can be the whole source code of your app). Instructions are a good way to guide the model which functions to test and how. If you don't need the instructions, set ")),
