...
const __vite_import_meta_env__ = { "BASE_URL": "/PromptingTools.jl/previews/PR227/", "DEV": false, "MODE": "production", "PROD": true, "SSR": false };
...
function pathToFile(path) {
  ...
  {
    if (inBrowser) {
      const base = "/PromptingTools.jl/previews/PR227/";
...
const assetsURL = function(dep) {
  return "/PromptingTools.jl/previews/PR227/" + dep;
};
const seen = {};
