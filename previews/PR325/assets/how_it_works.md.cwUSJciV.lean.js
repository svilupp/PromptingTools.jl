import { _ as _export_sfc, c as createElementBlock, o as openBlock, ai as createStaticVNode, j as createBaseVNode, a as createTextVNode, t as toDisplayString } from "./chunks/framework.CrG1-5H8.js";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", null, [
    ...
    createBaseVNode("p", null, [
      _cache[0] || (_cache[0] = createTextVNode('We want to have re-usable "prompts", so we provide you with a system to retrieve pre-defined prompts with placeholders (eg, ', -1)),
      createBaseVNode("code", null, toDisplayString(_ctx.name), 1),
      _cache[1] || (_cache[1] = createTextVNode(") that you can replace with your inputs at the time of making the request.", -1))
    ]),
    _cache[11] || (_cache[11] = createStaticVNode("", 3)),
    createBaseVNode("p", null, [
      _cache[2] || (_cache[2] = createTextVNode("Notice that we have a placeholder ", -1)),
      ...
      _cache[5] || (_cache[5] = createTextVNode(") that you can replace with your question without having to re-write the generic system instructions.", -1))
    ]),
    _cache[12] || (_cache[12] = createStaticVNode("", 64)),
    createBaseVNode("p", null, [
      _cache[6] || (_cache[6] = createTextVNode("Let's define a prompt and ", -1)),
      _cache[7] || (_cache[7] = createBaseVNode("code", null, "return_type", -1)),
      _cache[8] || (_cache[8] = createTextVNode(". Notice that we add several placeholders (eg, ", -1)),
