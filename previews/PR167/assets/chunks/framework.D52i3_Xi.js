...
const assetsURL = function(dep) {
  return "/PromptingTools.jl/previews/PR167/" + dep;
};
const seen = {};
...
var define_import_meta_env_default = { BASE_URL: "/PromptingTools.jl/previews/PR167/", MODE: "production", DEV: false, PROD: true, SSR: false };
...
function pathToFile(path) {
  ...
  {
    if (inBrowser) {
      const base = "/PromptingTools.jl/previews/PR167/";
