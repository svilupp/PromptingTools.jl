...
const __vite_import_meta_env__ = { "BASE_URL": "/PromptingTools.jl/v0.52.0/", "DEV": false, "MODE": "production", "PROD": true, "SSR": false };
...
function pathToFile(path) {
  ...
  {
    if (inBrowser) {
      const base = "/PromptingTools.jl/v0.52.0/";
...
const assetsURL = function(dep) {
  return "/PromptingTools.jl/v0.52.0/" + dep;
};
const seen = {};
