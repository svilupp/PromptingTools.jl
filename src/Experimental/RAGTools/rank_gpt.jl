...
function create_permutation_instruction(
        ...
        rank_end::Integer = 100, max_length::Integer = 300)
    ## 
    rank_end_adj = min(rank_end, length(context))
    num = rank_end_adj - rank_start + 1

    messages = render(AITemplate(:RAGRankGPT))
...
function permutation_step!(
        result::RankGPTResult; rank_start::Integer = 0, rank_end::Integer = 100, kwargs...)
...
function rank_sliding_window!(
        result::RankGPTResult; verbose::Int = 1, rank_start = 0, rank_end = 100,
...
"""
    rank_gpt(chunks::AbstractVector{<:AbstractString}, question::AbstractString; rank_start::Integer=0, rank_end::Integer=100, window_size::Integer=20, step::Integer=10, num_rounds::Integer=1, model::String="gpt4o", kwargs...)
...
function rank_gpt(chunks::AbstractVector{<:AbstractString}, question::AbstractString;
        verbose::Int = 1, rank_start::Integer = 0, rank_end::Integer = 100,
    ...
    for i in 1:num_rounds
        ...
        result = rank_sliding_window!(
            result; rank_start, rank_end, window_size, step, model, kwargs...)
    end
    (verbose >= 1) &&
