...
aliases = merge(
    Dict("gpt3" => "gpt-3.5-turbo",
        ...
        "claudes" => "claude-sonnet-4-6",
        "claudeo" => "claude-opus-4-6",
        ## Groq
...
registry = Dict{String, ModelSpec}(
    ...
    "gpt-5.4-mini" => ModelSpec("gpt-5.4-mini",
        OpenAISchema(),
        7.5e-7,
        4.5e-6,
        "GPT-5.4 Mini is a fast, capable small model for high-volume workloads. 400K context."),
    "gpt-5.4-nano" => ModelSpec("gpt-5.4-nano",
        OpenAISchema(),
        2e-7,
        1.25e-6,
        "GPT-5.4 Nano is the smallest and cheapest GPT-5.4 variant for classification, extraction, and ranking. 400K context."),
