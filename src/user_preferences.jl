...
registry = Dict{String, ModelSpec}(
    ...
    "gpt-5.5" => ModelSpec("gpt-5.5",
        ...
        5e-6,
        3e-5,
        "GPT-5.5, OpenAI's flagship model. 1M context, 128K output."),
    ...
    "claude-opus-4-8" => ModelSpec("claude-opus-4-8",
        ...
        5e-6,
        2.5e-5,
        "Anthropic's Claude Opus 4.8 model. 1M context, 128K output. See details [here](https://docs.anthropic.com/claude/docs/models-overview)"),
    ...
    "claude-sonnet-5" => ModelSpec("claude-sonnet-5",
        ...
        3e-6,
        1.5e-5,
        "Anthropic's Claude Sonnet 5 model. 1M context, 128K output. Introductory pricing of \$2/\$10 per 1M tokens applies through 2026-08-31. See details [here](https://docs.anthropic.com/claude/docs/models-overview)"),
    "claude-fable-5" => ModelSpec("claude-fable-5",
        AnthropicSchema(),
        1e-5,
        5e-5,
        "Anthropic's Claude Fable 5 model, the first Claude 5 family model in the Mythos-class tier above Opus. 1M context, 128K output. See details [here](https://docs.anthropic.com/claude/docs/models-overview)"),
