...
aliases = merge(
    Dict("gpt3" => "gpt-3.5-turbo",
        ...
        "claudes" => "claude-sonnet-4-5-20250929",
...
registry = Dict{String, ModelSpec}(
    ...
    "claude-sonnet-4-5-20250929" => ModelSpec("claude-sonnet-4-5-20250929",
        AnthropicSchema(),
        3e-6,
        1.5e-5,
        "Anthropic's Claude Sonnet 4.5 model - the best model for complex agents and coding with highest intelligence across most tasks. 200K context, 64K output. See details [here](https://docs.anthropic.com/claude/docs/models-overview)"),
