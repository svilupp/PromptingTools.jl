...
registry = Dict{String, ModelSpec}(
    ...
    "gpt-5.5" => ModelSpec("gpt-5.5",
        ...
        5e-6,
        30e-6,
        "GPT-5.5 is OpenAI's latest flagship model for complex tasks like coding, analysis, and planning. 1M context, 128K output."),
    ...
    "claude-sonnet-5" => ModelSpec("claude-sonnet-5",
        ...
        3e-6,
        1.5e-5,
        "Anthropic's Claude Sonnet 5 model, the latest Sonnet-class model balancing intelligence and speed. 1M context, 128K output. See details [here](https://docs.anthropic.com/claude/docs/models-overview)"),
