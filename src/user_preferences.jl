...
aliases = merge(
    Dict("gpt3" => "gpt-3.5-turbo",
        ...
        "gpt53i" => "gpt-5.3-chat-latest",
        "gpt54" => "gpt-5.4",
        "gpt54t" => "gpt-5.4-thinking",
        "gpt54p" => "gpt-5.4-pro",
        "gpt55" => "gpt-5.5",
        ...
        "claudes" => "claude-sonnet-5",
        "claude5" => "claude-sonnet-5",
        "claudef" => "claude-fable-5",
        "claudeo" => "claude-opus-4-8",
        ## Groq
        ...
        "gem31p" => "gemini-3.1-pro-preview",
        "gem31fl" => "gemini-3.1-flash-lite-preview",
...
registry = Dict{String, ModelSpec}(
    ...
    "gpt-5.3-codex" => ModelSpec("gpt-5.3-codex",
        OpenAIResponseSchema(),
        1.75e-6,
        14e-6,
        "GPT-5.3 Codex is OpenAI's most capable agentic coding model, combining frontier coding and reasoning. 400K context, 128K output."),
    "openai/gpt-5.3-codex" => ModelSpec("openai/gpt-5.3-codex",
        OpenAIResponseSchema(),
        1.75e-6,
        14e-6,
        "GPT-5.3 Codex with its internal name."),
    "gpt-5.3-chat-latest" => ModelSpec("gpt-5.3-chat-latest",
        OpenAISchema(),
        0.5e-6,
        4e-6,
        "GPT-5.3 Instant is optimized for everyday conversations with improved accuracy and fewer hallucinations. 400K context, 128K output."),
    "gpt-5.4" => ModelSpec("gpt-5.4",
        OpenAISchema(),
        2.5e-6,
        15e-6,
        "GPT-5.4 from OpenAI. 1M context."),
    "gpt-5.4-thinking" => ModelSpec("gpt-5.4-thinking",
        OpenAISchema(),
        2.5e-6,
        15e-6,
        "GPT-5.4 Thinking, reasoning variant with configurable effort. 1M context."),
    "gpt-5.4-pro" => ModelSpec("gpt-5.4-pro",
        OpenAIResponseSchema(),
        30e-6,
        180e-6,
        "GPT-5.4 Pro, highest-performance variant. 1M context."),
    "gpt-5.5" => ModelSpec("gpt-5.5",
        OpenAISchema(),
        5e-6,
        30e-6,
        "GPT-5.5 is OpenAI's latest flagship model for complex tasks like coding, analysis, and planning. 400K context, 128K output."),
    ...
    "claude-opus-4-8" => ModelSpec("claude-opus-4-8",
        AnthropicSchema(),
        5e-6,
        2.5e-5,
        "Anthropic's Claude Opus 4.8 model, the most capable Opus-tier model with state-of-the-art long-horizon agentic and knowledge work. 1M context, 128K output. See details [here](https://docs.anthropic.com/claude/docs/models-overview)"),
    "claude-opus-4-6" => ModelSpec("claude-opus-4-6",
        AnthropicSchema(),
        5e-6,
        2.5e-5,
        "Anthropic's Claude Opus 4.6 model. 1M context, 128K output. See details [here](https://docs.anthropic.com/claude/docs/models-overview)"),
    "claude-sonnet-4-6" => ModelSpec("claude-sonnet-4-6",
        AnthropicSchema(),
        3e-6,
        1.5e-5,
        "Anthropic's Claude Sonnet 4.6 model. 1M context, 128K output. See details [here](https://docs.anthropic.com/claude/docs/models-overview)"),
    "claude-sonnet-5" => ModelSpec("claude-sonnet-5",
        AnthropicSchema(),
        3e-6,
        1.5e-5,
        "Anthropic's Claude Sonnet 5 model, the latest Sonnet-class model balancing intelligence and speed. 1M context, 64K output. See details [here](https://docs.anthropic.com/claude/docs/models-overview)"),
    "claude-fable-5" => ModelSpec("claude-fable-5",
        AnthropicSchema(),
        1e-5,
        5e-5,
        "Anthropic's Claude Fable 5 model, its most capable model for the most demanding reasoning and long-horizon agentic work. 1M context, 128K output. See details [here](https://docs.anthropic.com/claude/docs/models-overview)"),
    ...
    "gemini-3.1-pro-preview" => ModelSpec("gemini-3.1-pro-preview",
        GoogleOpenAISchema(),
        2e-6,
        12e-6,
        "Google's Gemini 3.1 Pro Preview model with enhanced agentic capabilities and improved reliability. 1M context, 64K output. Price is for contexts ≤200K tokens."),
    "gemini-3.1-flash-lite-preview" => ModelSpec("gemini-3.1-flash-lite-preview",
        GoogleOpenAISchema(),
        0.25e-6,
        1.5e-6,
        "Google's Gemini 3.1 Flash Lite Preview is the fastest and most cost-efficient Gemini model. 1M context, 64K output."),
