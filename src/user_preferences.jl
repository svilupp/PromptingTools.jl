...
aliases = merge(
    Dict("gpt3" => "gpt-3.5-turbo",
        ...
        "gpt5" => "gpt-5-2025-08-08",
        "gpt5m" => "gpt-5-mini-2025-08-08",
        "gpt5n" => "gpt-5-nano-2025-08-08",
        ...
        "ggptoss120" => "gpt-oss-120b-groq",
        "ggptoss20" => "gpt-oss-20b-groq",
        ## Cerebras
        "cl3" => "llama3.1-8b",
        "cllama3" => "llama3.1-8b",
        "cl70" => "llama3.1-70b",
        "cllama70" => "llama3.1-70b",
        "cgptoss120" => "gpt-oss-120b-cerebras",
        "cgptoss20" => "gpt-oss-20b-cerebras",
        ## SambaNova
...
registry = Dict{String, ModelSpec}(
    ...
    "gpt-5-2025-08-08" => ModelSpec("gpt-5-2025-08-08",
        OpenAISchema(),
        1e-4,
        2e-4,
        "GPT-5 is the newest OpenAI flagship model with 2M context and 64K output."),
    "gpt-5" => ModelSpec("gpt-5",
        OpenAISchema(),
        1e-4,
        2e-4,
        "GPT-5 is the newest OpenAI flagship model with 2M context and 64K output."),
    "gpt-5-mini-2025-08-08" => ModelSpec("gpt-5-mini-2025-08-08",
        OpenAISchema(),
        5e-7,
        2e-6,
        "GPT-5 Mini balances capability and cost with 2M context and 32K output."),
    "gpt-5-mini" => ModelSpec("gpt-5-mini",
        OpenAISchema(),
        5e-7,
        2e-6,
        "GPT-5 Mini balances capability and cost with 2M context and 32K output."),
    "gpt-5-nano-2025-08-08" => ModelSpec("gpt-5-nano-2025-08-08",
        OpenAISchema(),
        1.5e-7,
        6e-7,
        "GPT-5 Nano is the most affordable GPT-5 variant with 1M context and 16K output."),
    ...
    "gpt-oss-120b-groq" => ModelSpec("gpt-oss-120b-groq",
        GroqOpenAISchema(),
        1.2e-6,
        2.4e-6,
        "Open-source GPT-OSS 120B model hosted by Groq. 128K context."),
    "gpt-oss-20b-groq" => ModelSpec("gpt-oss-20b-groq",
        GroqOpenAISchema(),
        2e-7,
        4e-7,
    ...
    "gpt-oss-120b-cerebras" => ModelSpec("gpt-oss-120b-cerebras",
        CerebrasOpenAISchema(),
        1.2e-6,
        2.4e-6,
        "Open-source GPT-OSS 120B model hosted by Cerebras. 8K context."),
    "gpt-oss-20b-cerebras" => ModelSpec("gpt-oss-20b-cerebras",
        CerebrasOpenAISchema(),
        2e-7,
        4e-7,
        "Open-source GPT-OSS 20B model hosted by Cerebras. 8K context."),
