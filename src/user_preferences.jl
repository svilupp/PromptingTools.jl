...
registry = Dict{String, ModelSpec}(
    ...
    "gpt-5.4" => ModelSpec("gpt-5.4",
        ...
        2.5e-6,
        15e-6,
        "GPT-5.4 is OpenAI's most capable frontier model for complex professional work. 1M context, native computer use, full-resolution vision."),
    "gpt-5.4-thinking" => ModelSpec("gpt-5.4-thinking",
        OpenAISchema(),
        2.5e-6,
        15e-6,
        "GPT-5.4 Thinking is the reasoning variant of GPT-5.4 with configurable reasoning effort. 1M context, native computer use."),
    "gpt-5.4-pro" => ModelSpec("gpt-5.4-pro",
        OpenAIResponseSchema(),
        30e-6,
        180e-6,
        "GPT-5.4 Pro is OpenAI's highest-performance model for maximum accuracy on the most difficult tasks. 1M context."),
