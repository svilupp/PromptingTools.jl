...
registry = Dict{String, ModelSpec}(
    ...
    "claude-fable-5" => ModelSpec("claude-fable-5",
        ...
        1e-6,
        5e-6,
        "Anthropic's Claude Fable 5 model, a fast and cost-effective member of the Claude 5 family. 200K context, 64K output. See details [here](https://docs.anthropic.com/claude/docs/models-overview)"),
