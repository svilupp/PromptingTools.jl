...
registry = Dict{String, ModelSpec}(
    ...
    "gemini-1.5-pro-latest" => ModelSpec("gemini-1.5-pro-latest",
        ...
        1.0e-6,
        5.0e-6,
        "Gemini 1.5 Pro is Google's most capable model, with a 128K context window."),
    "gemini-1.5-flash-8b-latest" => ModelSpec("gemini-1.5-flash-8b-latest",
        GoogleOpenAISchema(),
        0.0375e-6,
        0.15e-6,
        "Gemini 1.5 Flash 8B is Google's smaller, faster model optimized for efficiency, with a 128K context window."),
    "gemini-1.5-flash-latest" => ModelSpec("gemini-1.5-flash-latest",
        GoogleOpenAISchema(),
        0.075e-6,
        0.30e-6,
        "Gemini 1.5 Flash is Google's standard flash model, with a 128K context window."),
