using PromptingTools: StreamCallback, StreamChunk, OpenAIStream, AnthropicStream,
                      configure_callback!, OllamaStream, ResponseStream
using PromptingTools: OpenAISchema, AnthropicSchema, GoogleSchema, OllamaSchema, OpenAIResponseSchema
