...
- Added `MultiCandidateChunks` which can holds candidates for retrieval across many indices (it's a flat structure to be similar to `CandidateChunks` and easy to reason about).
