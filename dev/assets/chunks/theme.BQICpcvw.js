const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.BvMrKcTU.js","assets/chunks/framework.MOhMCOgy.js"])))=>i.map(i=>d[i]);
...
const _sfc_main$l = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.BvMrKcTU.js"), true ? __vite__mapDeps([0,1]) : void 0));
